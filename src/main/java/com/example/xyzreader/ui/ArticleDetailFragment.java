...
public class ArticleDetailFragment extends Fragment implements
    ...
    private static final String TAG = ArticleDetailFragment.class.toString();
...
//                mRootView.findViewById(R.id.insets_coordinator_layout);

        mToolbar = mRootView.findViewById(R.id.detail_toolbar);
        mPhotoView = (ImageView) mRootView.findViewById(R.id.article_image);
        CollapsingToolbarLayout mCollapsingToolbarLayout = mRootView.findViewById(R.id.collapsing_toolbar);
...
//        getActivityCast().getSupportActionBar().setDisplayShowHomeEnabled(true);
        ...
        if (mCursor != null) {
            ...
            titleView.setText(mArticleName);
